...
export default function EditDeviceComponent() {
    ...
    const putDeviceCompoment = async (e) => {
        e.preventDefault();


        if (validate()) {
            await axios.put(`${API}${APIName.DeviceCompoment}/UpdatedDeviceCompoment`,
                {
    ...
    return (
        <>
            <form onSubmit={putDeviceCompoment}>
                <Center>
                    <Text fontSize='40px' as='b' color='Blue'>Edit Device Component</Text>
                </Center>
                <br />
                <Center>
